...
def log(filename=str()):
    """декоратор log будет втоматически логировать начало и конец выполнения функции,
        а также ее результаты или возникшие ошибки. он  принимает необязательный аргумент
